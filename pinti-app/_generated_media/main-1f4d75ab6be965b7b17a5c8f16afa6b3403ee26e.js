...
jQuery(function($) {
    $.fn.fcbkcomplete = function(opt) {
        return this.each(function() {
            ...
            {
               //hide input field
               var input = $("#" + elemid + "_maininput");
               input.hide();
               
               //gray out container color
               holder.addClass("input_disabled");
            }
            ...
            function unlockInput()
            {
               ...
               //normalize container color
               holder.removeClass("input_disabled");
            }
            ...
            function addInput(focusme) {
                ...
                input.keyup(function(event) {
                    ...
                    if (event.keyCode != 40 && event.keyCode != 38 && event.keyCode!=37 && event.keyCode!=39 && (options.minchars ? etext.length >= options.minchars : etext.length != 0)) {
                        counter = 0;
            ...
            function addMembers(etext, data) {
                ...
                if (data != null && data.length) {
                    $.each(data,
                    function(i, val) {
                        var c = options.caption ? options.caption(val) : val.caption;
                        var v = options.value ? options.value(val): val.value;
                        cache.push ({
                           caption: c,
                           value: v
                        });
                        search_string += "" + (cache.length - 1) + ":" + c + ";";
                    });
                }
            ...
            function maxItems() {
                if (options.maxitems != 0) {
                	var len = holder.children("li.bit-box").length;
                    if (len < options.maxitems) {
                        return true;
                    }
                    else{
                        return false;
